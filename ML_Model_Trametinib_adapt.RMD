...
```{r}
#Load Files
Kinase_Activity <- read.csv("Kinase_activity_PDT.csv",h=T, row.names = "ids") #(loads kinase activity dataset)
Drug_Response<- read.csv("Drug_response.csv",h=T, row.names = "ids") #(loads drug response dataset)
